...
const main = async () => {
    ...
    console.log('Dogecoin deplyed to: ', dogeContract.address)
    ...
    console.log('Bitcoin deplyed to: ', bitcoinContract.address)
    ...
    console.log('Solana deplyed to: ', solanaContract.address)

    const usdcFactory = await ethers.getContractFactory('Usdc');
    const usdcContract = await usdcFactory.deploy();
    await usdcContract.deployed();
    console.log('USDC deplyed to: ', usdcContract.address)
}
